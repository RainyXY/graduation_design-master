...
//add a student
const addStudent = async (stu_id,stu_name,stu_gender, stu_age, stu_height,stu_weight, stu_tel,stu_major, stu_pay) => {
...
const updateInfo = async (stu_id, stu_name, stu_gender, stu_age, stu_height,stu_weight, stu_tel, stu_major,stu_pay) => {
  await studentSchema.update(
    {
      stu_id,
      stu_gender,
